...
export const createCustomer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const profile = yield Customer.findOne({ email });
        if (profile) {
...
export const signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (profile) {
            // @ts-ignore
            const validatePassword = yield bcrypt.compare(password, profile.password);
            if (validatePassword) {
...
export const EditProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (id == token.userId || token.role == 'Admin') {
            const result = yield Customer.findByIdAndUpdate(id, {
...
export const deleteUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = req.token;
    try {
        const profile = yield Customer.findById(token.userId);
        //@ts-ignore
        if (profile.role === 'Admin') {
            const user = yield Customer.findByIdAndDelete(id);
            return res.status(200).json({ message: `User ${user === null || user === void 0 ? void 0 : user.first_name} deleted successfully` });
        }
